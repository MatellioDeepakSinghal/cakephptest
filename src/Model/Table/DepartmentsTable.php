...
class DepartmentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        // $validator
        //     ->dateTime('department_created')
        //     ->requirePresence('department_created', 'create')
        //     ->notEmpty('department_created');

        $validator
            ->requirePresence('department_status', 'create')
            ->notEmpty('department_status');
